    ...
    def build_embed(
        *,
        ...
        requirement_text = (
            ...
            " Was macht der Bot?\n"
            "• Wenn du offline gehst, raidet der Bot automatisch einen anderen Partner\n"
            "• Es wird immer der Partner geraidet, der am kürzesten live ist\n"
            "• So helfen wir uns gegenseitig beim Wachstum\n"
            "• Du behältst die volle Kontrolle und kannst es jederzeit in deinem Chat mit `!raid_disable` ausschalten\n\n"
            " **Wichtig:** Der Bot braucht deine Erlaubnis auf Twitch, um in deinem Namen zu raiden.\n"
            " Klick einfach auf den Button unten, autorisier den Bot auf Twitch, fertig.\n"
            " Keine versteckten Funktionen, nur Raids – das war's.\n\n"
